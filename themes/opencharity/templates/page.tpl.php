...
<div id="page-wrapper"><div id="page">
    ...
    <?php  if ($main_menu) : ?>
      <div class="menu-mobile">
        <label for="menu-mobile__check" class="menu-mobile__control">
          <img src="<?php drupal_get_path('theme', 'opencharity') ?>/images/if_menu.png" class="menu-mobile__control__img">
        </label>
  ...
  <div id="main-wrapper" class="clearfix wrapper wrapper--main">
  ...
  <p>&nbsp;</p>
<?php
// echo views_embed_view('next_event', $display_id = 'block_next_event');

$block = module_invoke('views', 'next_event', 'block_next_event');
print '<pre>'. print_r($block, true) . '</pre>';
print '<pre>'. print_r($block['content']['#content'], true). '</pre>';
print '<pre>'. print_r(render($block['content']['#content']), true). '</pre>';
  ...
  <div id="footer-wrapper" class="foot">
    <div class="section wrapper">
      <div class="foot__follow">
        ...
        <a href="gplus">
          <img src="gplus" alt="follow us on Google+">
        </a>
      </div>
      <hr class="foot__hr">
